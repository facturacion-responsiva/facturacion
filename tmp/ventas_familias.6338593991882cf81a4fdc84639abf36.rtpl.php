      ...
      <div class="col-sm-12">
         <div class="page-header">
            <h1>
               ...
               <a id="b_nueva_familia" class="btn btn-xs btn-success" href="#">
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  Código:
                  <input class="form-control" type="text" name="ncodfamilia" maxlength="8" autocomplete="off" required=""/>
               </div>
               <div class="form-group">
                  Descripción:
                  <input class="form-control" type="text" name="ndescripcion" autocomplete="off" required=""/>
               </div>
            </div>
