...
<form id="f_subcuenta" class="form" action="<?php echo $fsc->url();?>&offset=<?php echo $fsc->offset;?>" method="post">
   ...
   <div class="table-responsive">
      <table class="table table-hover">
         ...
         <tr>
            ...
            <td>
               <input class="form-control" type="text" name="descripcion" value="<?php echo $fsc->subcuenta->descripcion;?>" autocomplete="off"/>
            </td>
            <td>
            ...
            <td>
               ...
               <option value="<?php echo $value1->coddivisa;?>"<?php if( $fsc->subcuenta->coddivisa==$value1->coddivisa ){ ?> selected=""<?php } ?>><?php echo $value1->descripcion;?></option>
               <?php } ?>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            ...
            <a href="<?php echo $fsc->pdf_libromayor;?>" target="_blank" class="btn btn-sm btn-default">
               <span class="glyphicon glyphicon-book"></span> &nbsp; Libro mayor
            </a>
            <?php }else{ ?>
