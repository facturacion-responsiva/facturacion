   ...
   <div class="container-fluid" style="margin-top: 10px;">
      ...
      <div class="row">
         ...
         <div class="col-sm-6">
            ...
            <p class="help-block">
               <b><?php  echo FS_IRPF;?></b>: si quieres añadir <?php  echo FS_IRPF;?> a un <?php  echo FS_PEDIDO;?>,
               <?php  echo FS_ALBARAN;?> o factura, usa una serie que tenga <?php  echo FS_IRPF;?>.
            </p>
            <p class="help-block">
               <b>RE</b>: si quieres añadir recargo de equivalencia a un <?php  echo FS_PEDIDO;?>,
               <?php  echo FS_ALBARAN;?> o factura de compra, debes activar el recargo de
               equivalencia en Admin &gt; Empresa &gt; Facturación.
            </p>
         </div>
      </div>
   </div>
         ...
         onSelect: function (suggestion) {
            if(suggestion)
            {
               if(document.f_nueva_compra.proveedor.value != suggestion.data)
               {
                  ...
                  document.f_nueva_compra.nuevo_dni.value = '';
               }
            }
         }
      });
