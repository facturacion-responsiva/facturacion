   ...
   <div class="table-responsive">
      <table class="table table-hover">
         ...
         <tr>
            ...
            <td><input class="form-control" type="text" name="descripcion" value="<?php echo $fsc->cuenta->descripcion;?>" autocomplete="off"/></td>
            <td>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-10">
                     <input class="form-control" type="text" name="nsubcuenta" value="<?php echo $fsc->nuevo_codsubcuenta;?>" autocomplete="off" autofocus />
                  </div>
               </div>
               <div class="form-group">
